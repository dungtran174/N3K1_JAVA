...
public class J05058_SapXepKetQuaTuyenSinh {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= n; i++)
            students.add(new Student8(sc.nextLine(), sc.nextLine(), Double.parseDouble(sc.nextLine()),
...
class Student8 {
    ...
    public Student8(String id, String name, double score1, double score2, double score3) {
        this.id = id;
