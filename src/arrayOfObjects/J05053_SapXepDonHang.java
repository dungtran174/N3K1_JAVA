...
public class J05053_SapXepDonHang {
    public static void main(String[] args) {
        ...
        int t = sc.nextInt();
        ArrayList<Item4> li = new ArrayList<>();
        for(int i = 0; i < t; i++) {
            sc.nextLine();
            li.add(new Item4(sc.nextLine(), sc.nextLine(), sc.nextInt(), sc.nextInt()));
        }
        li.sort(Comparator.comparing(Item4::getNumber));
...
class Item4 {
    ...
    public Item4(String name, String id, int unitPrice, int amount) {
        this.name = name;
        this.id = id;
