...
public class J05061_SapXepKetQuaXetTuyen {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= t; i++) {
            students.add(new Student10(i, sc.nextLine(), sc.nextLine(), Double.parseDouble(sc.nextLine()),
...
class Student10 {
    ...
    public Student10(int i, String name, String birthday, double score1, double score2) {
