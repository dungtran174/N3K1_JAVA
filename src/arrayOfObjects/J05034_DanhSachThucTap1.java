...
public class J05034_DanhSachThucTap1 {
    ...
    public static void main(String[] args) {
        ...
        sc.nextLine();
        for (int i = 0; i < t; i++) {
            list.add(new Student4(i + 1, sc.nextLine(), sc.nextLine(), sc.nextLine(),
...
class Student4 {
    ...
    public Student4(int ordinals, String id, String name, String className, String email, String company) {
        this.id = id;
        this.name = name;
