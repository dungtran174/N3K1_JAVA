...
public class J05041_SapXepBangTinhCong{
    public static void main(String[] args) {
        ...
        for(int i = 0; i < t; i++) {
            sc.nextLine();
            list.add(new Employee2(i + 1, sc.nextLine(), sc.nextInt(), sc.nextInt(), sc.next()));
        }
        list.sort((a, b) -> b.getNetIncome() - a.getNetIncome());
...
class Employee2 {
    ...
    public Employee2(int id, String name, int basicSalary, int workingDays, String position) {
