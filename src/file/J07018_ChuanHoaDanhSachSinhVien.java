...
public class J07018_ChuanHoaDanhSachSinhVien {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (int i = 1; i <= n; i++)
            System.out.println(new Student11(String.format("B20DCCN%03d", i), sc.nextLine(), sc.nextLine(), sc.nextLine(),
...
class Student11 {
    ...
    public Student11(String id, String name, String group, String birthDay, double GPA) {
        this.id = id;
        setName(name);
        this.group = group;
